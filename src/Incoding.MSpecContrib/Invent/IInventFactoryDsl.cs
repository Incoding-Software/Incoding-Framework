namespace Incoding.MSpecContrib
{
    ...
    {
        IInventFactoryDsl<T> GenerateTo<TGenerate>(Expression<Func<T, object>> property) where TGenerate : new();

        IInventFactoryDsl<T> GenerateTo<TGenerate>(string property) where TGenerate : new();

        IInventFactoryDsl<T> Empty<TGenerate>(Expression<Func<T, object>> property);

        IInventFactoryDsl<T> Empty<TGenerate>(string property);

        IInventFactoryDsl<T> Tuning(Expression<Func<T, object>> property, object value);

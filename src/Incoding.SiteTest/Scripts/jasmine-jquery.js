        ...
        spyOn : function(selector, eventName) {
         ...
         wasTriggered : function(selector, eventName, dataEvent) {
            ...
            if (dataEvent != undefined) {
                expect(dataEvent).toEqual(event.data);
            }
...
!function() {
    var jQueryMatchers = {
        ...
        toHandle : function(event) {
            ...
            var events = $._data($(this.actual), 'events');
...
beforeEach(function() {
    ...
    this.addMatchers({
        toHaveBeenTriggeredOn : function(selector, eventData) {
            ...
            return jasmine.JQuery.events.wasTriggered(selector, this.actual, eventData);
        }
    });
    this.addMatchers({
        toHaveBeenTriggered : function(eventData) {
            ...
            return jasmine.JQuery.events.wasTriggered(selector, eventName, eventData);
        }
    });
    this.addMatchers({

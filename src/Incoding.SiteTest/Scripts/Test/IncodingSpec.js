...
describe('Incoding', function() {
    ...
    describe('Framework', function() {
        ...
        describe('Infrastructure', function() {
            ...
            describe('Core', function() {
                ...
                describe('Url extend', function() {
                    ...
                    describe('When url read', function() {
                    ...
                    describe('When url write', function() {
            ...
            describe('IncodingRunner', function() {
                ...
                describe('When doIt', function() {
                    ...
                    it('Should be DoIt filter by event type', function() {
                        ...
                        var before = createCallback('noclick');
                        runner.before.push(before);

                        var success = createCallback('noclick');
                        runner.success.push(success);

                        var error = createCallback('noclick');
                        runner.error.push(error);

                        var complete = createCallback('noclick');
                        runner.complete.push(complete);
                        ...
                        expect(before.execute).not.toHaveBeenCalled();
            ...
            describe('When AjaxAdapter', function() {
                ...
                describe('When request', function() {
                    ...
                    beforeEach(function() {
                        isCallback = false;
                        fakeUrl = 'url';
                        expectData = [{ element : 'val' }];

                        ajaxOptions = TestHelper.Instance.GetAjaxOptions({ url : fakeUrl, data : expectData });
                ...
                describe('When params', function() {
                    ...
                    it('Should params empty', function() {
            ...
            describe('IncodingResult', function() {
                ...
                describe('When success result', function() {
                    ...
                    function BehaviorsSuccessParseServerResult(result) {
                        ...
                        expect(result.isRedirectTo()).toBeFalsy();
            ...
            describe('Executable helpers', function() {
                ...
                describe('When ExecutableHelper TryGetVal', function() {
                    ...
                    it('Should be wrong selector', function() {
                    ...
                    it('Should be jquery code', function() {
                        var selector = "$('#sandboxTextarea')";
                        TestHelper.Instance.SandboxTextArea().val('aws');

                        expect(ExecutableHelper.Instance.TryGetVal(selector)).toEqual('aws');
                    });

                    it('Should be with jquery selector as string', function() {
                        var selector = new String('#sandboxTextarea');
                        TestHelper.Instance.SandboxTextArea().val('aws');

                        expect(ExecutableHelper.Instance.TryGetVal(selector)).toEqual('aws');
                    });

                    it('Should be content with html', function() {
                        var selector = "Aws <br/> <div>my new content </div> <input/>";
                        expect(ExecutableHelper.Instance.TryGetVal(selector)).toEqual(selector);
                    });

                    it('Should be content with html 2', function() {
                    ...
                    it('Should be query string', function() {
                        var val = ExecutableHelper.Instance.TryGetVal("'@@@incodingParam@@@'");
                        expect(val).toEqual('incValue');
                    });

                    it('Should be hash query string', function() {
                        window.location.hash = "Index/Home?incodingHashParam=incValue";

                        var val = ExecutableHelper.Instance.TryGetVal("'@@@@@incodingHashParam:root@@@@@'");
                        expect(val).toEqual('incValue');
                    });
                    ...
                    it('Should be hash', function() {
                        ...
                        var val = ExecutableHelper.Instance.TryGetVal("'@@@@root@@@@'");
                        expect(val).toEqual('Index/Home');
                    });

                    it('Should be href', function() {
                        var val = ExecutableHelper.Instance.TryGetVal("'@@href@@'");
                        expect(val).toEqual(decodeURIComponent(window.location.href));
                    });

                    it('Should be cookie', function() {
                        var cookiesVal = 'cookiesVal';
                        $.cookie('incValue', cookiesVal);

                        var val = ExecutableHelper.Instance.TryGetVal("'@@@@@@incValue@@@@@@'");
                    ...
                    it('Should be ajax', function() {
                        ...
                        ExecutableHelper.Instance.TryGetVal('\'@@@@@@@{"cache":false,"data":"[{\\\"name\\\":\\\"Type\\\",\\\"selector\\\":\\\"$(\'#sandboxTextBox\')\\\"}]","url":"/Template/Get","type":"GET","async":false}@@@@@@@\'');

                        expect(AjaxAdapter.Instance.request).toHaveBeenCalledWith({
                                cache : false,
                                data : [{ name : 'Type', selector : 'typeValue' }],
                                url : "/Template/Get",
                                type : "GET",
                                async : false
                            }, function() {
                ...
                describe('When ExecutableHelper RedirectTo', function() {
                    ...
                    it('Should be redirect', function() {
                        ...
                        runs(function() {
                            document.location.hash = 'aws'; //clear hash
        ...
        describe('Template', function() {
            ...
            describe('When pecial template', function() {

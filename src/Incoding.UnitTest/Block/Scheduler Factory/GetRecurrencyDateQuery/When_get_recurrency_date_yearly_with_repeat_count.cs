namespace IncodingContrib.UnitTest
{
    ...
    public class When_get_recurrency_date_yearly_with_repeat_count
    {
        #region Fields

        Establish establish = () =>
                                  {
                                      GetRecurrencyDateQuery query = Pleasure.Generator.Invent<GetRecurrencyDateQuery>(dsl => dsl.Tuning(r => r.Type, GetRecurrencyDateQuery.RepeatType.Yearly)

namespace Incoding.UnitTest
{
    ...
    public class When_command_composite_quote_fluent_api
    {
        #region Fake classes

        [MessageExecuteSetting(Connection = "TheSameConnectionString", DataBaseInstance = "TheSameDataBase",IsolationLevel = IsolationLevel.Snapshot)]

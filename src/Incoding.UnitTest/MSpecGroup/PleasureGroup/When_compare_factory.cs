namespace Incoding.UnitTest.MSpecGroup
{
    ...
    public class When_compare_factory
    {
        ...
        class FakeCompareWithIgnore
        {
            ...
            [IgnoreFieldCompare("Design fixed"), UsedImplicitly]
        ...
        It should_not_be_compare_class_with_duplicate_field = () =>
                                                                  {
                                                                      ...
                                                                      compare.Compare(Pleasure.Generator.Invent<FakeCompareDuplicate>(), new FakeCompareDuplicate());
                                                                      compare.IsCompare().ShouldBeFalse();
                                                                  };
        ...
        It should_be_not_compare_collection_string = () =>
                                                         {
                                                             ...
                                                             compare.IsCompare().ShouldBeFalse();
                                                             compare.GetDifferencesAsString().ShouldContain("Compare  Item from Actual with Item from Expected");
                                                         };

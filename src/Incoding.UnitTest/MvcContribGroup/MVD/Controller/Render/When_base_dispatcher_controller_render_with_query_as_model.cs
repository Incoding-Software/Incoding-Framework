namespace Incoding.UnitTest.MvcContribGroup
{
    ...
    public class When_base_dispatcher_controller_render_with_query_as_model : Context_dispatcher_controller_render
    {
        ...
        Because of = () => { result = controller.Render("View", typeof(FakeRenderQuery).FullName, string.Empty, true); };

        It should_be_render = () =>
                                  {
                                      Action<ViewContext> verify = s => s.ViewData.Model.ShouldBeOfType<FakeRenderQuery>();

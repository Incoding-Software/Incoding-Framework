namespace Incoding.UnitTest.MvcContribGroup
{
    ...
    public class When_base_dispatcher_controller_push_by_old_inc_type : Context_dispatcher_controller
    {
        ...
        Because of = () => { result = controller.Push(string.Empty, incType: typeof(FakeCommand).Name); };

namespace Incoding.UnitTest.MvcContribGroup
{
    ...
    public class When_base_dispatcher_controller_query_by_name_with_url_encode : Context_dispatcher_controller
    {
        ...
        Because of = () => { result = controller.Query(HttpUtility.UrlEncode(typeof(ShareQuery).Name), false); };

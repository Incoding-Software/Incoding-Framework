namespace Incoding.UnitTest.MvcContribGroup
{
    ...
    public class When_base_dispatcher_controller_query_by_name : Context_dispatcher_controller
    {
        #region Fake classes
        ...
        Because of = () => { result = controller.Query(HttpUtility.UrlEncode(typeof(FakeByNameQuery).Name), string.Empty, false); };
